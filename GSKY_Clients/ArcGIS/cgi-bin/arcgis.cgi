...
$docroot = "/var/www/vhosts/webgenie.com/httpdocs/GSKY/GoogleEarth";
$kmlDir = "$docroot/KML";
$cgi = "/var/www/vhosts/webgenie.com/httpdocs/GSKY/GoogleEarth/cgi-bin/google_earth.cgi"; # On VM19
$basedir = "$docroot/GEWeb/DEA_Layers";
$localdir = $docroot;
$url = "https://$domain";
#$url = $ENV{HTTP_REFERER};
$url = $url . "/GSKY/GoogleEarth/KML";
